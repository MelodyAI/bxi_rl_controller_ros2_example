...
```bash
# build local
source /home/xuxin/allCode/bxi_ros2_pkg/setup.bash
./build.sh
...
ros2 launch bxi_example_py_trunk example_launch_hand.py
...
ros2 launch bxi_example_py_trunk example_launch_hand_hw.py
