...
class humanoid_far_jump_Agent(baseAgent):
    ...
    def build_observations(self, obs_group):
        ...
        if motion_time_norm < 0.:
            motion_time_norm = 0
        if motion_time_norm < self.motion_start:
            motion_time_norm = self.motion_start
...
if __name__=="__main__":
    ...
    a=humanoid_far_jump_Agent("/home/xuxin/allCode/bxi_ros2_example/src/bxi_example_py_trunk/policy/0805_dance.onnx",
