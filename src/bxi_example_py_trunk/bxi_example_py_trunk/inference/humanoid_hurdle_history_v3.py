...
if __name__=="__main__":
    a=humanoid_hurdle_onnx_Agent("/home/xuxin/allCode/bxi_ros2_example/src/bxi_example_py_trunk/policy/20250729_044024_elf2_dof23_noOdometry_0_adamimic_stage1_double.onnx")
    obs_group={
        "dof_pos":np.zeros(23),
        "dof_vel":np.zeros(23),
        "angular_velocity":np.zeros(3),
