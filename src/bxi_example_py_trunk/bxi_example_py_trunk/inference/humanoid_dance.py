...
class humanoid_dance_Agent(baseAgent):
...
if __name__=="__main__":
    ...
    a=humanoid_dance_Agent("/home/xuxin/allCode/bxi_ros2_example/src/bxi_example_py_trunk/policy/0805_dance.onnx",
                                     motion_time_increment, motion_difficulty, motion_range=[0,1.0])
