...
class humanoid_walk_stand_height_onnx_Agent(baseAgent):
    def __init__(self, policy_path):
        self.num_prop_obs_input = 48
        self.long_history = 15
        self.num_actions = 12
    ...
    def build_observations(self, obs_group):
        ...
        self.stand_height = obs_group["stand_height"]
        obs_dof_pos = (obs_group["dof_pos"] - self.default_dof_pos * self.stand_height) * self.obs_scale["dof_pos"]
        ...
        if stand:
            ...
            obs_phase[1] = 1
            self.phase_count = 0
        obs_stand_height = self.stand_height
    ...
    def inference(self, obs_group):
        ...
        dof_pos_target_urdf = actions * self.action_scale + self.default_dof_pos * self.stand_height
...
if __name__=="__main__":
    a=humanoid_walk_stand_height_onnx_Agent("/home/xuxin/allCode/bxi_ros2_example/src/bxi_example_py_trunk/policy/walk_example_height.onnx")
    a.reset()
    obs_group={
        "dof_pos":np.zeros(12),
        "dof_vel":np.zeros(12),
